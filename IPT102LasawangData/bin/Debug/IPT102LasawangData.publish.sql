...
GO
:setvar DatabaseName "Faculty"
:setvar DefaultFilePrefix "Faculty"
...
GO
PRINT N'Creating Index [dbo].[Faculty].[IX_Faculty_Code]...';


GO
CREATE NONCLUSTERED INDEX [IX_Faculty_Code]
    ON [dbo].[Faculty]([Code] ASC) WHERE [Code] IS NOT NULL;


GO
PRINT N'Creating Procedure [dbo].[CreateFaculty]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Deletefaculty]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetfacultyById]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[Updatefaculty]...';
